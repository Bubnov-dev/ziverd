$(document).ready(function () {
    ...
    function resize(){
        ...
        if (document.documentElement.clientWidth <= 568){
            console.log($('.slider-grid').hasClass('slick-initialized'))
            if(!$('.slider-grid').hasClass('slick-initialized')){
            ...
            if($('.slider-grid').hasClass('slick-initialized')){
                ...
                $(".slider-grid").slick("unslick");
            }
        }
        if (document.documentElement.clientWidth <= 360){
            if(!$('.assortment-screen__grid').hasClass('slick-initialized')){
            ...
            if($('.assortment-screen__grid').hasClass('slick-initialized')){
                ...
                $(".assortment-screen__grid").slick("unslick");
            }
        }
